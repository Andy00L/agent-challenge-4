...
export function NodeOutputPanel({ step, onClose }: Props) {
  ...
  return (
    <div className="absolute right-0 top-0 h-full w-[380px] bg-white border-l shadow-lg flex flex-col animate-slide-in-right z-30">
      {/* Header */}
      ...
      {/* Market info */}
      {step.market && (
        <div className="px-5 py-2.5 border-b flex items-center gap-3 text-xs text-muted-foreground">
